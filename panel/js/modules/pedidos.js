...
window.accionPedido = function(id, tipo) {
  ...
  // Reset fields
  document.getElementById('accion-submit-btn').className = 'px-4 py-2 bg-primary text-white rounded-lg hover:bg-green-700';
  document.getElementById('accion-guia').value = '';
  document.getElementById('accion-transportadora').value = '';
  document.getElementById('accion-motivo').value = '';
